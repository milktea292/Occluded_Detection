...
b) For training: I took individual images with all perspectives (back-, front-, side-view), and applied methods that simulated the occlusion scenarios. Only these images are regarded as training set.
